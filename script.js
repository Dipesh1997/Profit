class CustomerManager {
    constructor() {
        // DOM Elements
        this.customersContent = document.getElementById('customers-content');
    ...
    setupEventListeners() {
        ...
        this.addButton.addEventListener('click', () => {
            if (document.querySelector('.nav-item.active').dataset.tab === 'customers') {
        ...
        document.querySelectorAll('.nav-item').forEach(item => {
            item.addEventListener('click', (e) => {
                ...
                if (tabName === 'customers') {
                    this.customersContent.classList.add('active');
                    this.renderCustomers();
                } else {
                    this.customersContent.classList.remove('active');
                }
            });
        });
    }
